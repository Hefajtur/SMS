...
@section('body')
    ...
    <div class="container py-5 ">
        <div class="row">
            <div class="col-md-11 mt-5 bg-white mx-5 py-3">
                <div class="">
                    <h3 class="bradecrumb-title mb-1 px-2 mt-2">Exam Routine</h3>
                ...
                <form action="" method="POST" id="examroutine_insert">
                    <fieldset>
                        @csrf
                        ...
                        <div class="row mt-5">
                            ...
                            <div class="col-md-3 mb-3">
                                ...
                                <input type="date" name="date" class="form-control inputs" id="date" required>
                            ...
                            <div class="col-12 col-md-12 mb-5">
                                <div class="row shadow py-4 mb-5">
                                    <div
                                        ...
                                        <h3 class="text-dark">Add Subject, Time & Room</h3>
                                        <div class="button">
    ...
    <script>
        $('#examroutine_insert').validate();

        $(document).ready(function() {

            $('#examroutine_insert').submit(function(e) {
                e.preventDefault();
