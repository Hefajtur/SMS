...
<div class="container py-5 px-5">
    ...
    <!-- Page Content -->
    <form action="#" method="POST" class="" id="update_qstGroup_form" qstGroup_id="{{ $edit_data->id }}">
        <fieldset>
            @csrf
...
<script>
    ...
    $(document).ready(function() {
        ...
        // Update Data
        $('#update_qstGroup_form').submit(function(e) {
            e.preventDefault();
            ...
            var url = '{{ route("question-group.update", ":id") }}';
