...
@section('body')
        ...
        <div class="row">
            <div class="col-md-11 mt-5 mx-5 py-3">
                <div class="row  bg-white">
                    <div class="">
                        <h4 class="bradecrumb-title mb-1 px-2 mt-2">Class</h4>
                ...
                <div class="row  bg-white mt-3">
                    <div class="col-12 mb-3 d-flex justify-content-between mt-3">
                        ...
                        <a href="{{ route('class.create') }}" class="text-white btn btn-primary p-3"><i
                                class="fa fa-plus pe-1"></i>Add</a>
                    </div>

                    <div class="col-md-11 mt-1 mb-5 mx-auto">
                        <table class="table" id="classData" style="border: 0">
                            <thead>
                                <tr>
    ...
    <script>
        ...
        $('#classData').on('click', '#class_edit', function(e) {
            ...
            window.location.href = url + "/class/" + id +"/edit";
        });

        //// Delete class

        $('#classData').on('click', '#class_delete', function() {
            let id = $(this).attr("class_id");
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        ...
                        if (response.success == true) {
                            ...
                            var oTable = $('#classData').dataTable();
                            oTable.fnDraw(false);
