    ...
    <div class="container py-5 ">
        <div class="row">
            <div class="col-md-11 mt-5 bg-white mx-5 py-3">
                <div class="">
                    <h3 class="bradecrumb-title mb-1 px-2 mt-2">Create Subject</h3>
                    <ol class="breadcrumb  bg-white">
                        <li class="breadcrumb-item" style="font-size: 15px"><a href="">Home</a></li>
                        <li class="breadcrumb-item" style="font-size: 15px">Subject</li>
                        <li class="breadcrumb-item" style="font-size: 15px">Add New</li>
                    </ol>
                </div>
                <form action="" method="POST" id="subject_insert">
                    <fieldset>
                        @csrf
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 ">
                                ...
                                <select name="status" required class="form-control js-example-basic-single" id="type_status">
   ...
   {{-- add subject --}}
    ...
    <script>
        $(document).ready(function() {
            ...
            $('#subject_insert').submit(function(e) {
                e.preventDefault();
  var isValid = true;
