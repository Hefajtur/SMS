...
@section('body')
    ...
    <div class="container py-5 ">
        <div class="row">
            <div class="col-md-11 mt-5 bg-white mx-5 py-3">
                <div class="">
                    <h3 class="bradecrumb-title mb-1 px-2 mt-2">Create Expense</h3>
                    <ol class="breadcrumb  bg-white">
                        <li class="breadcrumb-item" style="font-size: 15px"><a href="">Home</a></li>
                        <li class="breadcrumb-item" style="font-size: 15px">Expense
                        </li>
                        <li class="breadcrumb-item" style="font-size: 15px"><a href="">Add New</a></li>
                    </ol>
                </div>
                <form action="" method="POST" id="expense_insert" enctype="multipart/form-data">
                    <fieldset>
                        @csrf
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 ">
                                <label class="label_name">Expense Head<span class="text-danger">*</span></label><br>
    ...
    <script>
        $(document).ready(function() {
                    ...
                    $('#expense_insert').submit(function(e) {
                        e.preventDefault();
       ...
       var isValid = true;
        ...
        if (isValid) {
                        x = new FormData(document.getElementById("expense_insert"));
                        $.ajax({
