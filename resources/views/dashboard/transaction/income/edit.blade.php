...
@section('body')
    ...
    <div class="container py-5 ">
        <div class="row">
            <div class="col-md-11 mt-5 bg-white mx-5 py-3">
                <div class="">
                    <h3 class="bradecrumb-title mb-1 px-2 mt-2">Edit Income</h3>
                    <ol class="breadcrumb  bg-white">
                        <li class="breadcrumb-item" style="font-size: 15px"><a href="">Home</a></li>
                        <li class="breadcrumb-item" style="font-size: 15px"><a href="">Income
                        </a></li>
                        <li class="breadcrumb-item" style="font-size: 15px">Edit</li>
                    </ol>
                </div>
                <form action="" method="POST" id="income_update" income_id="{{ $incomes->id }}">
                    <fieldset>
                        @csrf
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3 form-group">
                                ...
                                <input type="text" class="form-control inputs" placeholder="Enter name" name="name"
                                    id="name" value="{{$incomes->name}}" required>
                                    {{-- hidden id  --}}
                                    <input type="hidden" value="{{ $incomes->id }}" name="id"> 
                            ...
                            <div class="col-md-6 ">
                                ...
                                <select name="income_expenses_id" class="form-control inputs js-example-basic-single" required>
                                    <option value="{{ $incomes->incomeExpenses->id }}">{{ $incomes->incomeExpenses->name }}
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 ">
                                ...
                                <input type="date" name="date" value="{{$incomes->date}}"  class="form-control inputs" required>
                                <span id="date_error" class="error"></span>
                            </div>

                            <div class="col-md-6 ">
                                <label class="label_name">Invoice Number <span class="text-danger">*</span></label><br>
                                <input type="number" name="invoice_num" value="{{$incomes->invoice_num}}"  class="form-control inputs"
                        ...
                        <div class="row mt-3">
                            ...
                            <div class="col-md-6 ">
                                ...
                                <input type="number" name="amount" required value="{{$incomes->amount}}" class="form-control inputs" placeholder="Enter amount">
                                <span id="amount_error" class="error"></span>
                            </div>

                            <div class="col-md-6 ">
                                <label class="label_name">Document <span class="text-danger">*</span></label>
                                <input type="file" name="document" class="form-control inputs" value="{{ $incomes->document }}">
                        ...
                        <div class="row mt-3">
                            ...
                            <div class="col-md-12 ">
                                ...
                                <textarea name="description" id="" class="form-control inputs" style="width: 100%" rows="4"
                                    placeholder="Enter description" required>{{$incomes->description}}</textarea>
    ...
    <script>
        $(document).ready(function() {
            $('#income_update').submit(function(e) {
                e.preventDefault();
      ...
      var isValid = true;
        ...
        if (isValid) {
                ...
                x = new FormData(document.getElementById("income_update"));
                let id = $(this).attr("income_id");
                $.ajax({
                    url: url + "/incomeUpdate/" + id,
                    method: "POST",
                    data: x,
                    processData: false,
                    contentType: false,
