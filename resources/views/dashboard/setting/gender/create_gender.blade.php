...
<div class="container py-5 px-5">
            ...
            <div class="page_hading_bredcrumb">
                ...
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb breadcrumb_bg">
                        ...
                        <li class="breadcrumb-item"><a href="{{ route('genders.index') }}">Gender</a></li>
    ...
    <!-- Page Content -->
    <form action="#" method="POST" class="card" id="create_gender_form">
        <fieldset>
            @csrf
            <div class="inputs_data row card-body py-5">
                <div class="col-12 col-md-6">
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control inputs" minlength="3" name="name" value="{{ old('gender') }}" id="gender" placeholder="Enter name" required>
...
<script>
    $('#create_gender_form').validate();

    $(document).ready(function() {

        // Add Data to DB
        $('#create_gender_form').submit(function(e) {
            e.preventDefault();
