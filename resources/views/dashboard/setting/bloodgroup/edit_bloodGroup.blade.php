...
<div class="container py-5 px-5">
    ...
    <!-- Page Content -->
    <form action="#" method="POST" class="card" id="update_bloodgroup_form" blood_id="{{ $edit_data->id }}">
        <fieldset>
            @csrf
            <div class="inputs_data row card-body py-5">
                <div class="col-12 col-md-6">
                    <div class="mb-3">
                        <label for="bloodGroup" class="form-label label_name">Name <span class="text-danger fillable">*</span></label>

                        <input type="text" class="form-control inputs" minlength="2" name="name" value="{{ $edit_data->name }}" id="bloodGroup" placeholder="Enter name" required>
...
$('#update_bloodgroup_form').validate();

    $(document).ready(function() {


        // Update Data
        $('#update_bloodgroup_form').submit(function(e) {
            e.preventDefault();
            ...
            var url = '{{ route("blood-groups.update", ":id") }}';
                ...
                $.ajax({
                    ...
                    success: function(data) {
                        ...
                        if (data.success == true) {
                            // $('#update_bloodgroup_form')['0'].reset();
