...
<div class="container py-5 px-5">
            ...
            <div class="page_hading_bredcrumb">
                ...
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb breadcrumb_bg">
                        ...
                        <li class="breadcrumb-item"><a href="{{ route('member-category.index') }}">Edit Member Category</a></li>
    ...
    <!-- Page Content -->
    <form action="#" method="POST" class="card" id="update_memberCat_form" memberCategory_id="{{ $edit_data->id }}">
        <fieldset>
            @csrf
            <div class="inputs_data row card-body py-5">
                <div class="col-12 col-md-6">
                    <div class="mb-3">
                        <label for="memberCatName" class="form-label label_name">Name <span class="text-danger fillable">*</span></label>

                        <input required type="text" class="form-control inputs" minlength="3" name="member_cat_name" value="{{ $edit_data->member_cat_name }}" id="memberCatName" placeholder="Enter name" required>

                        <span id="member_cat_name_error" class="error"></span>
...
<script>
    $('#update_memberCat_form').validate();

    $(document).ready(function() {


         // Update Data
         $('#update_memberCat_form').submit(function(e) {
            e.preventDefault();

            // alert('clicked');

            let id = $(this).attr('memberCategory_id');
            var url = '{{ route("member-category.update", ":id") }}';
            ...
            $.ajax({
                ...
                success: function(data) {
                    ...
                    if (data.success == true) {
                        $('#update_memberCat_form')['0'].reset();
                        alert('Member category updated Successfully');
